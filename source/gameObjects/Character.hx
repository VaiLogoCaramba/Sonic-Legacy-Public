...
class Character extends FlxSprite
{
	...
	//allows the ghost anims to play
	public var playGhostAnims:Bool = false;
	...
	function loadMappedAnims():Void
	{
		...
		gameObjects.stageObjects.TankmenBG.animationNotes = animationNotes;
