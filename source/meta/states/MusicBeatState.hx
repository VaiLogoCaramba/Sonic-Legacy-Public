...
class MusicBeatState extends FlxUIState
{
	...
	override function update(elapsed:Float)
	{
		...
		uiCallFunction((ui:BaseUI)->{ui.update(elapsed);});
	...
	public var uiHandler:Array<BaseUI> = [];
	function uiCallFunction(call:BaseUI->Void)
	{
		for (i in uiHandler) if (i != null && i.exists && i.active) call(i);
	}
