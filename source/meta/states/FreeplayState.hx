...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			if (songs[i].displayName == 'Obituary') songs[i].displayName = 'Free-4-Me';
	...
	override function update(elapsed:Float)
	{
		...
		else if (accepted)
		{
			...
			if (songLowercase == 'obituary' && ClientPrefs.getGameplaySetting('botplay',false)) songLowercase = Paths.formatToSongPath('free-4-me');
